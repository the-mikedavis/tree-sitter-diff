...
(async () => {
  ...
  async function handleLanguageChange() {
    ...
    if (!languagesByName[newLanguageName]) {
      const url = 'https://raw.githubusercontent.com/the-mikedavis/tree-sitter-git-diff/main/tree-sitter-git_diff.wasm'
  ...
  function loadState() {
    const language = localStorage.getItem("languageDiff");
    const sourceCode = localStorage.getItem("sourceCodeDiff");
    const query = localStorage.getItem("queryDiff");
    const queryEnabled = localStorage.getItem("queryEnabledDiff");
  ...
  function saveState() {
    localStorage.setItem("languageDiff", languageSelect.value);
    localStorage.setItem("sourceCodeDiff", codeEditor.getValue());
    saveQueryState();
  }

  function saveQueryState() {
    localStorage.setItem("queryEnabledDiff", queryCheckbox.checked);
    localStorage.setItem("queryDiff", queryEditor.getValue());
  }
